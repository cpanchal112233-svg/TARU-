...
void main() {
  ...
  test(
    'recent-auth purge failure stays a product error, not a crash payload',
    () {
      ...
      expect(
        ...
        isNot(contains('RECENT_AUTH_REQUIRED')),
      );
    },
  );

  test(
    'health deletion guard blocks MainShell and leaves guard untouched',
    () async {
      final FakeFirebaseFirestore firestore = FakeFirebaseFirestore();
